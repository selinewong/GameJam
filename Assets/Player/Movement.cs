    ...
    public struct RayData
{
    ...
    if (_inputActions.PlayerActionMap.Movement == null)
{
    Debug.LogError("Movement action is not assigned in the Input Actions asset.");
}


    if (_inputActions.PlayerActionMap.Movement == null)
        Debug.LogError("Movement action is null!");
    ...
    void ApplyGravity()
{
    if (planet == null)
    {
        Debug.LogError("Planet not assigned! Please assign it in the inspector.");
        return;
    }
    ...
    {
        Debug.LogError("Planet component missing on planet object!");
        return;
    }

    if (!groundData.grounded)
        gravityStrength += planetComponent.GravitationalPull * Time.deltaTime;
    else
